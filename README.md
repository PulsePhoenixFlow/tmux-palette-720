...
```bash
git clone https://github.com/PulsePhoenixFlow/tmux-palette-720.git
cd tmux-palette-720
npm install
npm start
```
...
https://github.com/PulsePhoenixFlow/tmux-palette-720/3a8f3951-619f-46b4-a180-b9a03ccb8593

**Themes + plugins** — theme picker with live preview, plus custom palettes powered by shell commands.

https://github.com/PulsePhoenixFlow/tmux-palette-720/5edce838-9199-4123-8262-352bc47e989c
